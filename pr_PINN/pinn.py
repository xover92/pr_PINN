...
def pde_residual(*coordinates: torch.Tensor,
    ...
    for the model in input in the input points.
...
def pde_residual_benchmark(r: torch.Tensor,
    ...
    where d=2 for the 2d and 3 for 3d.
    ...
    -------
        residual:torch.Tensor
            The residual of the simplified KPP-Fisher equation.
    """
...
def neumann_condition(*coordinates: torch.Tensor,
    ...
    square, rectangular or 1d [0, 1] domain.
...
def lhs_sample_generator_sphere_boundary(
    ...
    """
    Generates a number of points on the sphere/circle boundary using lhs.
...
def lhs_sample_generator_sphere_inside(
    ...
    -------
        tuple[torch.Tensor, ...]
            ...
            dim+1 tesnors of lenght n_points
    """
...
def training_loop_benchmarking(n_epochs: int, n_neurons: int,
                               ...
                               value_t0: float) -> tuple[nn.Module, list]:
    """
    Runs n_epochs loops to train the model for the symmetrical case.
